    ...
    <form action="" method="post">
        <ul>
            <li align="center">
                ...
                <input class="input-text" size="60px" type="text" name="nik" id="nik" autocomplete="off" required placeholder="NIK">
            </li>
            <li align="center">
              
                <input class="input-text" size="60px" type="text" name="nama" id="nama" autocomplete="off" required placeholder="NAMA">
            </li>
            <li align="center">
              
                <input class="input-text" size="60px" type="text" name="pekerjaan" id="pekerjaan" autocomplete="off" required placeholder="PEKERJAAN"> 
            </li>
            <li align="center"> 
             
                <input class="input-text" size="60px" type="text" name="nama_anak" id="nama_anak" autocomplete="off" required placeholder="NAMA ANAK">
            </li>
            <li align="center">
              
                <input class="input-text" size="60px" type="text" name="noHp" id="noHp" autocomplete="off" required placeholder="NO HANDPHONE">
            </li>
            <li align="center">
               
                <input class="input-text" size="60px" type="text" name="alamat" id="alamat" autocomplete="off" placeholder="ALAMAT">
            </li>
            <li align="center">
